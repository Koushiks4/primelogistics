...
export default function Footer({ onTrackOpen }: { onTrackOpen?: () => void }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button onClick={onTrackOpen} className="text-sm text-gray-400 hover:text-brand-red transition-colors">
                    Track Shipment
                  </button>
                </li>
              </ul>
